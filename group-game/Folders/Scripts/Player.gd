...
var attacking = false
var stagger = false
@export var sword_swish_sfx: AudioStream = preload("res://Folders/Sounds/Knife Swish.mp3.mp3")
@export var sword_hit_flesh_sfx: AudioStream = preload("res://Folders/Sounds/Sword Hit Flesh.mp3.mp3")
@export var example_sound: AudioStream = preload("res://Folders/Sounds/alex_jauk-slap-237622.mp3")
